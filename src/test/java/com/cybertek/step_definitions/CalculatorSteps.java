...
import com.cybertek.pages.CalculatePage;
...
public class CalculatorSteps {
    ...
    @Given("User is on calculator home page")
    ...
    public void user_clicks_on_on_calculator(String buttonText) {
        ...
        calculatePage.clickOn(buttonText);
    }
    ...
    public void result_should_be_displayed(String expectedResult) {
        ...
        String actualResult = calculatePage.result.getText().trim();
